...
public class Base {
	...
	public void setupWebDriver() throws IOException  {
		...
		fis = new FileInputStream(projectPath + "\\src\\properties\\locator.properties"); // Text file //FileNotFoundException //child Exception
		
		locatorProp = new Properties(); // IOException is a mother Exception
